                            ...
                            <div class="accordion-collapse collapse" id="collapseOne" data-bs-parent="#accordionSection">
                                <div class="accordion-body price__import">
                                    <div class='input-group'>
                                        <input type='text' placeholder='Giá sản phẩm' name='subject_price' value="<?php echo e($rowSubject['subject_price']); ?>" aria-label='First name' class='form-control'>
                                        <input type='text' placeholder='Giá giảm sản phẩm' name='subject_sale' value="<?php echo e($rowSubject['subject_sale']); ?>" aria-label='Last name' class='form-control'>
                                    </div>
                                </div>
                            </div>
