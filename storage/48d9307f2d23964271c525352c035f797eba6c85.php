        ...
        <div class="row">
                            ...
                            <div class="accordion-collapse collapse" id="collapseOne" data-bs-parent="#accordionSection">
                                <div class="accordion-body price__import">
                                    <div class='input-group'>
                                        <input type='text' placeholder='Giá khóa học' name='subject_price' value="<?php echo e($rowSubject['subject_price']); ?>" aria-label='First name' class='form-control'>
            ...
            <div class="col">
                ...
                <div class="mb-3">
                    ...
                    <br>
                    <textarea class="input-text" placeholder="Giới thiệu khóa học" name="subject_description" rows="5" cols="65"><?php echo e($rowSubject['subject_description']); ?></textarea>
                </div>
            </div>
        </div>
