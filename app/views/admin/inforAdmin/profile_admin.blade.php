                                    ...
                                    <div class="row gutters">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="fullName" value="{{$admin['name']}}" placeholder="Enter full name">
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label for="eMail">Email</label>
                                                <input type="email" value="{{$admin['email']}}" class="form-control" id="eMail" placeholder="Enter email ID">
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label for="phone">Phone</label>
                                                <input type="text" value="{{$admin['phone']}}" class="form-control" id="phone" placeholder="Enter phone number">
                                            </div>
                                        </div>
